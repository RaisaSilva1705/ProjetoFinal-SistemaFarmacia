-- #####################################################################
-- SCRIPT DE TESTE ATUALIZADO COM REGISTRO MS E NOVOS CONTROLADOS
-- #####################################################################

-- ---------------------------------------------------------------------
-- Exemplo 1: DORFLEX
-- ---------------------------------------------------------------------
INSERT INTO PRODUTOS (ID_Categoria, Nome, Marca, ID_Fornecedor, Descricao, ID_Unidade, NCM, EAN_GTIN, Status) VALUES (1, 'Dorflex 10cpr', 'Sanofi', 1, 'Analgésico e relaxante muscular', 2, '30049039', '7891058021832', 'Ativo');
...
-- ---------------------------------------------------------------------
INSERT INTO PRODUTOS (ID_Categoria, Nome, Marca, ID_Fornecedor, Descricao, ID_Unidade, NCM, EAN_GTIN, Status) VALUES (1, 'Dipirona Monoidratada 500mg 10cpr', 'Medley', 2, 'Analgésico e antitérmico genérico', 2, '30049039', '7896422516314', 'Ativo');
...
-- ---------------------------------------------------------------------
INSERT INTO PRODUTOS (ID_Categoria, Nome, Marca, ID_Fornecedor, Descricao, ID_Unidade, NCM, EAN_GTIN, Status) VALUES (1, 'Amoxicilina 500mg 21cpr', 'EMS', 2, 'Antibiótico genérico', 2, '30041011', '7896004706132', 'Ativo');
...
-- ---------------------------------------------------------------------
INSERT INTO PRODUTOS (ID_Categoria, Nome, Marca, ID_Fornecedor, Descricao, ID_Unidade, NCM, EAN_GTIN, Status) VALUES 
(1, 'Torsilax 12cpr', 'Neo Química', 1, 'Anti-inflamatório, analgésico e relaxante muscular', 2, '30049039', '7896714216839', 'Ativo');
...
-- ---------------------------------------------------------------------
INSERT INTO PRODUTOS (ID_Categoria, Nome, Marca, ID_Fornecedor, Descricao, ID_Unidade, NCM, EAN_GTIN, Status) VALUES 
(1, 'Losartana Potássica 50mg 30cpr', 'CIMED', 2, 'Anti-hipertensivo genérico', 2, '30049069', '7897947613567', 'Ativo');
...
-- ---------------------------------------------------------------------
INSERT INTO PRODUTOS (ID_Categoria, Nome, Marca, ID_Fornecedor, Descricao, ID_Unidade, NCM, EAN_GTIN, Status) VALUES 
(1, 'Rivotril 2,5mg/ml Gotas 20ml', 'Roche', 1, 'Ansiolítico', 1, '30049079', '7896226503525', 'Ativo');
...
-- ---------------------------------------------------------------------
INSERT INTO PRODUTOS (ID_Categoria, Nome, Marca, ID_Fornecedor, Descricao, ID_Unidade, NCM, EAN_GTIN, Status) VALUES 
(1, 'Clonazepam 2,5mg/ml Gotas 20ml', 'Geolab', 2, 'Ansiolítico genérico', 1, '30049079', '7898222384261', 'Ativo');
...
-- ---------------------------------------------------------------------
INSERT INTO PRODUTOS (ID_Categoria, Nome, Marca, ID_Fornecedor, Descricao, ID_Unidade, NCM, EAN_GTIN, Status) VALUES 
(1, 'Paracetamol 750mg 20cpr', 'EMS', 2, 'Analgésico e antitérmico genérico', 2, '30049029', '7896004708341', 'Ativo');
...
-- ---------------------------------------------------------------------
INSERT INTO PRODUTOS (ID_Categoria, Nome, Marca, ID_Fornecedor, Descricao, ID_Unidade, NCM, EAN_GTIN, Status) VALUES 
(1, 'Loratadina 10mg 12cpr', 'CIMED', 1, 'Antialérgico genérico', 2, '30049069', '7897947600109', 'Ativo');
...
-- ---------------------------------------------------------------------
INSERT INTO PRODUTOS (ID_Categoria, Nome, Marca, ID_Fornecedor, Descricao, ID_Unidade, NCM, EAN_GTIN, Status) VALUES 
(1, 'Ritalina 10mg 20cpr', 'Novartis', 1, 'Tratamento de TDAH', 2, '30049079', '7896261006023', 'Ativo');
...
-- ---------------------------------------------------------------------
INSERT INTO PRODUTOS (ID_Categoria, Nome, Marca, ID_Fornecedor, Descricao, ID_Unidade, NCM, EAN_GTIN, Status) VALUES 
(1, 'Paco 30mg/500mg 12cpr', 'Eurofarma', 2, 'Analgésico opioide', 2, '30049039', '7891317496290', 'Ativo');
